  ...
  <div class="products-view">
    ...
    <div v-else-if="products.length > 0" class="table-container">
      <table class="data-table">
        <thead>
          <tr><th>ID</th><th>Name</th><th>Number</th><th>Color</th><th>Price</th><th>Category</th><th>Subcategory</th></tr>
        </thead>
        <tbody>
          ...
          -->
          <tr><td colspan="7" class="placeholder">Workshop: Implement v-for rows</td></tr>
        </tbody>
      </table>
...
export default {
  name: 'ProductsView',
  data() { return { products: [], searchName: '', searchCategory: '', loading: false, error: null } },
  methods: {
    formatPrice(p) { return new Intl.NumberFormat('en-US',{style:'currency',currency:'USD'}).format(p) },
    async handleLoadAll() {
